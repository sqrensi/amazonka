Shader "Horror/Terrain Lit Triplanar"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/MAIN/Shaders/Terrain/TerrainLitPassesTriplanar.hlsl"
            ENDHLSL
        }
    ...
    Dependency "AddPassShader" = "Hidden/Horror/Terrain Lit Triplanar Add"
